...
function default_1(h5pEditor, h5pPlayer, languageOverride) {
    ...
    router.get("".concat(h5pEditor.config.playUrl, "/:contentId"), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var h5pPage, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, h5pPlayer.render(req.params.contentId, req.user, languageOverride === 'auto'
    ...
    router.get('/delete/:contentId', auth_1.checkPermission, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_2 = _a.sent();
                    res.send("Error deleting content with id ".concat(req.params.contentId, ": ").concat(error_2.message, "<br/><a href=\"javascript:window.location=document.referrer\">Go Back</a>"));
                    res.status(500).end();
                    return [2 /*return*/];
                case 3:
                    res.send("Content ".concat(req.params.contentId, " successfully deleted.<br/><a href=\"javascript:window.location=document.referrer\">Go Back</a>"));
                    res.status(200).end();
                    return [2 /*return*/];
            }
        });
