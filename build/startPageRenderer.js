            ...
            switch (_a.label) {
                    ...
                    return [4 /*yield*/, Promise.all(contentIDs.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _a = {};
                                        return [4 /*yield*/, editor.contentManager.getContentMetadata(id.contentId.toString(), req.user)];
                ...
                case 3:
                    ...
                    res.send("\n        <!doctype html>\n        <html>\n        <head>\n            <meta charset=\"utf-8\">\n            <script src=\"/node_modules/requirejs/require.js\"></script>\n            <link rel=\"stylesheet\" href=\"/node_modules/bootstrap/dist/css/bootstrap.min.css\">\n            <link rel=\"stylesheet\" href=\"/node_modules/@fortawesome/fontawesome-free/css/all.min.css\">\n            <title>H5P NodeJs Demo</title>\n            <style>\n                    /* Additional custom styles */\n                    .logout-button {\n                    position: absolute;\n                    top: 10px;\n                    right: 10px;\n                    }\n            </style>\n        </head>\n        <body>\n            <div class=\"container\">\n                <h1>H5P NodeJs Demo</h1>\n                <button class=\"btn btn-danger logout-button\" id=\"logout\">Log out</button>\n                <div class=\"alert alert-warning\">This demo is for debugging and demonstration purposes only and not suitable for production use!</div>                \n                <h2>\n                    <span class=\"fa fa-file\"></span> Existing content\n                </h2>\n                <a class=\"btn btn-primary my-2\" href=\"".concat(editor.config.baseUrl, "/new\"><span class=\"fa fa-plus-circle m-2\"></span>Create new content</a>\n                <div class=\"list-group\">\n                ").concat(contentObjects
                        ...
                        return "<div class=\"list-group-item\">\n                                <div class=\"d-flex w-10\">\n                                    <div class=\"me-auto p-2 align-self-center\">\n                                        <a href=\"".concat(editor.config.baseUrl).concat(editor.config.playUrl, "/").concat(content.id.contentId, "\">\n                                            <h5>").concat(content.content.title, "</h5>\n                                        </a>\n                                        <div class=\"small d-flex\">                                            \n                                            <div class=\"me-2\">\n                                                <span class=\"fa fa-book-open\"></span>\n                                                ").concat(content.content.mainLibrary, "\n                                            </div>\n                                            <div class=\"me-2\">\n                                                <span class=\"fa fa-fingerprint\"></span>\n                                                ").concat(content.id.contentId, "\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <div class=\"p-2\">                                        \n                                        <a class=\"btn btn-secondary\" href=\"").concat(editor.config.baseUrl, "/edit/").concat(content.id.contentId, "\">\n                                            <span class=\"fa fa-pencil-alt m-1\"></span>\n                                            edit\n                                        </a>\n                                    </div>\n                                    <div class=\"p-2\">\n                                        <a class=\"btn btn-info\" href=\"").concat(editor.config.baseUrl).concat(editor.config.downloadUrl, "/").concat(content.id.contentId, "\">\n                                            <span class=\"fa fa-file-download m-1\"></span>\n                                            download\n                                        </a>\n                                    </div>\n                                    <div class=\"p-2\">\n                                        <a class=\"btn btn-info\" href=\"").concat(editor.config.baseUrl, "/html/").concat(content.id.contentId, "\">\n                                            <span class=\"fa fa-file-download m-1\"></span>\n                                            download HTML\n                                        </a>\n                                    </div>\n                                    <div class=\"p-2\">\n                                        <a class=\"btn btn-danger\" href=\"").concat(editor.config.baseUrl, "/delete/").concat(content.id.contentId, "\">\n                                            <span class=\"fa fa-trash-alt m-1\"></span>\n                                            delete\n                                        </a>\n                                    </div>\n                                </div>                                \n                            </div>");
                    })
