...
var createToken = function (userId, email, role) {
    var payload = {
        userId: userId,
        email: email,
        role: role
...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, newUser, salt, hashedPassword, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (existingUser) {
                    return [2 /*return*/, res.status(400).json({ message: 'Người dùng đã tồn tại' })];
                }
                newUser = new User_1.default({ email: email, password: password });
...
router.post('/login', function (req, res, next) {
    passport_1.default.authenticate('local', { session: false }, function (err, user, info) {
        ...
        console.log(user);
        // Tạo token JWT
        var token = jsonwebtoken_1.default.sign({ id: user._id }, 'your_secret_key');
